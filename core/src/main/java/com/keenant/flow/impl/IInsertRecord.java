...
public class IInsertRecord implements InsertRecord {
    private Exp table;
    private final List<Map<String, Exp>> records;

    public IInsertRecord(Exp table) {
        this.table = table;
    ...
    @Override
    public InsertRecord cpy() {
        IInsertRecord insert = new IInsertRecord(table);
        for (Map<String, Exp> record : records) {
    ...
    @Override
    public InsertRecord table(Exp table) {
        this.table = table;
        return this;
    }

    @Override
    public InsertRecord with(String field, Exp value) {
        currentRecord().put(field, value);
        return this;
    }

    @Override
    public InsertRecord with(String field, Object value) {
