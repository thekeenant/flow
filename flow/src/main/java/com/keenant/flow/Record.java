...
public interface Record {
  ...
  <T, U> Optional<U> get(String label, Transformer<T, U> transformer)
      throws NoSuchElementException, ClassCastException;

  <T, U> U getNonNull(int field, Transformer<T, U> transformer)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  <T, U> U getNonNull(String label, Transformer<T, U> transformer)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  Object getNonNull(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  Object getNonNull(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  String getNonNullString(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  String getNonNullString(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  Number getNonNullNumber(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  Number getNonNullNumber(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  int getNonNullInt(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  int getNonNullInt(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  double getNonNullDouble(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  double getNonNullDouble(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  float getNonNullFloat(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  float getNonNullFloat(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  long getNonNullLong(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  long getNonNullLong(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  boolean getNonNullBoolean(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  boolean getNonNullBoolean(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  Date getNonNullDate(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  Date getNonNullDate(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  Time getNonNullTime(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  Time getNonNullTime(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
  ...
  Timestamp getNonNullTimestamp(int index)
      throws NoSuchElementException, ClassCastException, IllegalStateException;

  Timestamp getNonNullTimestamp(String label)
      throws NoSuchElementException, ClassCastException, IllegalStateException;
}
